...
public class TheTrident extends Attack{
    ...
    public void threeLines(Board boardAtacado, int[][] puntos){
        if (puntos.length != 3) return; //tienen que ser 3 puntos  
    ...
    public void threeNumbers(Board boardAtacado, int[] numerosTrident, int[] numerosAtacado){
        ...
        if (numerosTrident.length != 3 || numerosAtacado.length != 3) return;
